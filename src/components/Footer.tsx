  ...
  <footer className="border-t border-border py-12 px-6">
    <div className="mx-auto max-w-7xl flex flex-col md:flex-row items-center justify-between gap-6">
      ...
      <div className="flex items-center gap-5">
        ...
        {/* Join our Discord CTA */}
        <motion.a
          href="https://discord.gg/UFx2PNFS45"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-2 border border-primary/30 px-4 py-2 rounded-lg text-primary hover:bg-primary/10 transition-all duration-300 ml-2"
        ...
        >
          ...
          <span className="text-[10px] tracking-[0.15em] uppercase font-display">Join our Discord</span>
        </motion.a>
      </div>
