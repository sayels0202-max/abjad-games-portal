      ...
      <div ref={containerRef} className="relative h-[200vh]">
        ...
        >
          ...
          >
            ...
            >
              <a href="https://x.com/AbjadGames" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors duration-300" title="X (Twitter)">
                <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
              </a>
              <a href="https://discord.gg/UFx2PNFS45" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-2 mirror-surface mirror-edge border border-primary/30 px-6 py-3 rounded-xl text-primary hover:bg-primary/10 transition-all duration-300" title="Join our Discord">
                ...
                <span className="font-display text-xs tracking-[0.25em] uppercase">Join our Discord</span>
              </a>
              <a href="https://www.linkedin.com/company/abjad-games" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors duration-300" title="LinkedIn">
